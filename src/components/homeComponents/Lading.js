        ...
        <section className="bg-[url('https://1dg.me/assets/client//media/svg/illustrations/landing.svg')] bg-[#13263c] dark:bg-gray-900 pt-10" id="hero" >
            <div className="py-16 px-4 mx-auto max-w-screen-xl text-center lg:py-20 lg:px-12">
                ...
                <div className="flex flex-col mb-8 lg:mt-16 lg:mb-24  space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    <button type="button" className={userInfo?"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 hidden" :"text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"}>Sign up now!</button>
